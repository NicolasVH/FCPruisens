 ...
 */
class Club extends \Fcp\SiteBundle\Entity\Club implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setDefaultLocation($defaultLocation);
    }
    ...
    {
        return array('__isInitialized__', 'id', 'clubName', 'defaultLocation');
    }

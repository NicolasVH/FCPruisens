...
class appdevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/spelers')) {
            ...
            // player_statistics
            if ($pathinfo === '/spelers/statistieken') {
                return array (  '_controller' => 'Fcp\\SiteBundle\\Controller\\PlayerController::StatisticsAction',  '_route' => 'player_statistics',);
            }
        ...
        if (0 === strpos($pathinfo, '/wedstrijden')) {
            // fixture_index
            if (rtrim($pathinfo, '/') === '/wedstrijden') {
                if (substr($pathinfo, -1) !== '/') {
                    return $this->redirect($pathinfo.'/', 'fixture_index');
                }

                return array (  '_controller' => 'Fcp\\SiteBundle\\Controller\\FixtureController::IndexAction',  '_route' => 'fixture_index',);
            }

            // fixture_show
            if (preg_match('#^/wedstrijden/(?P<id>[^/]++)/?$#s', $pathinfo, $matches)) {
                if (substr($pathinfo, -1) !== '/') {
